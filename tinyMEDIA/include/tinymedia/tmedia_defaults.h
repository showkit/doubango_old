...
TINYMEDIA_API int tmedia_defaults_set_pref_video_framerate(unsigned pref_video_framerate);
TINYMEDIA_API unsigned tmedia_defaults_get_pref_video_framerate();
