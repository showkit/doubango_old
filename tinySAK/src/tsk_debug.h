...
#define TSK_DEBUG_INFO(FMT, ...)		\
	if(tsk_debug_get_level() >= DEBUG_LEVEL_INFO){ \
        if(tsk_debug_get_logger_cb()) \
            tsk_debug_get_logger_cb()(tsk_debug_get_arg_data(), "*INFO: " FMT "\n", ##__VA_ARGS__); \
...
#define TSK_DEBUG_WARN(FMT, ...)		\
	if(tsk_debug_get_level() >= DEBUG_LEVEL_WARN){ \
        if(tsk_debug_get_logger_cb()) \
            tsk_debug_get_logger_cb()(tsk_debug_get_arg_data(), "**WARN: " FMT "\n", ##__VA_ARGS__); \
...
#define TSK_DEBUG_ERROR(FMT, ...) 		\
	if(tsk_debug_get_level() >= DEBUG_LEVEL_ERROR){ \
        if(tsk_debug_get_logger_cb()) \
            tsk_debug_get_logger_cb()(tsk_debug_get_arg_data(), "***ERROR: " FMT "\n", ##__VA_ARGS__); \
...
#define TSK_DEBUG_FATAL(FMT, ...) 		\
	if(tsk_debug_get_level() >= DEBUG_LEVEL_FATAL){ \
        if(tsk_debug_get_logger_cb()) \
            tsk_debug_get_logger_cb()(tsk_debug_get_arg_data(), "****FATAL: " FMT "\n", ##__VA_ARGS__); \
