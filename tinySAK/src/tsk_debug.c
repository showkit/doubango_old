...
static tsk_debug_f tsk_debug_logger_cb = tsk_null;

void tsk_debug_set_logger_cb(tsk_debug_f cb) {
    tsk_debug_logger_cb = cb;
}
tsk_debug_f tsk_debug_get_logger_cb() {
    return tsk_debug_logger_cb;
}
