...
typedef enum twrap_media_type_e
{
	...
	twrap_media_audio_video_t140 = 0x0b,
        twrap_media_data = 0x10,
        twrap_media_audiovideodata = 0x13
}
twrap_media_type_t;
...
static tmedia_type_t twrap_get_media_type(twrap_media_type_t type)
{
	...
	switch(type){
		...
		case twrap_media_audio_video_t140:
			...
			break;
                case twrap_media_data:
			media_type |= (tmedia_data);
			break;
                case twrap_media_audiovideodata:
			media_type |= (tmedia_data | tmedia_audio | tmedia_video);
			break;
        default:
            break;
	}
